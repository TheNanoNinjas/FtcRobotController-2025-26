...
@Autonomous(name = "Auto Blue Close", group = "Competition")
public class AutoBlueCloseODO extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        driveBackwardTimed(0.35,1200);
        launchArtifacts(4500);

        turnRightTimed(0.3,450);

        driveBackwardTimed(0.35,350);
        ...
        driveForwardTimed(0.35,1550);
        intake.stopPushing();
        shooter.stopShooting();
        pusher.stopPushing();
        turnLeftTimed(0.3,1400);

        driveForwardTimed(0.3,80);

        launchArtifacts(4500);

        turnRightTimed(0.3,1000);
