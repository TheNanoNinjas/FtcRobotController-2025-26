...
@Autonomous(name = "TestRedAutonomous", group = "Competition")
public class TestRedAutonomous extends OpMode {
    ...
    private void turnToHeadingStage2(double targetHeading, int nextStage) throws InterruptedException {
        ...
        double errorBeforeAdjusting = targetHeading - currentHeading;
        ...
        telemetry.addData("errorBeforeAdjusting", errorBeforeAdjusting);
